...
class ArmorListViewModel : ViewModel() {
    ...
    private val _armorListLiveData = MutableLiveData<List<ArmorPiece>>()
    val armorListLiveData: LiveData<List<ArmorPiece>>
        get() = _armorListLiveData

    private val filter = ArmorListFilterCriteria()
    private val _filterLiveData = MutableLiveData<ArmorListFilterCriteria>()
    val filterLiveData: LiveData<ArmorListFilterCriteria>
        get() = _filterLiveData
    ...
    private fun updateFilteredArmor() {
        ...
        _armorListLiveData.postValue(filtered)
    }
